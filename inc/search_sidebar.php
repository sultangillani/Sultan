            ...
            <div class="fil-options ct cta stre">
                <?php
                    while($store_row = mysqli_fetch_assoc($store_result)){
                        ...
                        ?>
                            <span id="st<?php echo $store_id; ?>"><div class="boxx"></div><input type="checkbox" name="store" value="<?php echo $store_slug; ?>" id="dis-<?php echo $store_slug; ?>" ng-model="dis<?php echo str_ireplace('-','',$store_slug); ?>" ng-checked="dis<?php echo str_ireplace('-','',$store_slug); ?>" title="<?php echo $store_slug; ?>"/> <label for="dis-<?php echo $store_slug; ?>"><?php echo $store_name; ?></label></span><br class="smethng" />
                ...
                <div class="fil-options ct cta stre">
                    <?php
                        while($category_row = mysqli_fetch_assoc($category_result)){
                            ...
                            ?>
                                <span id="st<?php echo $category_id; ?>" ><div class="boxx"></div><input type="checkbox" name="cat" value="<?php echo $category_slug; ?>" id="dis-<?php echo $category_slug; ?>" ng-model="dis<?php echo str_ireplace('-','',$category_slug); ?>" ng-checked="dis<?php echo str_ireplace('-','',$category_slug); ?>" title="<?php echo $category_slug; ?>"/> <label for="dis-<?php echo $category_slug; ?>"><?php echo $category_name; ?></label></span><br class="smethng" />
                            <?php
                        }
                    ?>
                </div>
