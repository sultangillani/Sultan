                        ...
                        $(document).ready(function(){
                            ...
                            $('.next_btn').click(function(){
                                ...
                                $.ajax({
                                    method: 'POST',
                                    url: pathname,
                                    data: {action: 'tags_coupons', page_id: page_id, usp:us, total_posts: total_posts, gd_arr: gd_arr},
                                    success: function(result){
                                        $('.main-cont').html(result);
                                    }
                                });
