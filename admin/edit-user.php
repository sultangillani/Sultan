        ...
        <div class="container-fluid body-sections">
            <div class="row">
                ...
                <div class="col-md-9 admin-content">
                    <h1><i class="fa fa-edit"></i> Edit User <small>Edit User Details</small></h1>
                    <hr />
                    <ol class="breadcrumb">
                    ...
                    <?php
                        if(isset($_POST['submit'])){
                            ...
                            if(empty($first_name) || empty($last_name) || empty($image_name) ){
                                ...
                                $update_query = "UPDATE `users` SET `first_name`= '$first_name', `last_name`= '$last_name', `image`= '$image_name', `role`= '$role', `details`= '$details'";
                                if(!empty($image_name)){
